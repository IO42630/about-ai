...
sentiment_classifier = pipeline("sentiment-analysis") # select, download, and cache default model for sentiment analysis

print(sentiment_classifier("I've been waiting for a HuggingFace course my whole life."))
print(sentiment_classifier(["I've been waiting for a HuggingFace course my whole life.", "I hate this so much!"]))
...
unmasker = pipeline("fill-mask") # fill in the blank
